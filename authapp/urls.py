...
urlpatterns = [
    ...
    path(
        "", LoginView.as_view(template_name="registration/login.html", redirect_authenticated_user=True), name="login"
    ),
    path("logout/", LogoutView.as_view(template_name="authapp/logged_out.html"), name="logout"),
    path(
        "password_change/",
        PasswordChangeView.as_view(template_name="authapp/password_change_form.html"),
        name="password_change",
    ),
    path(
        "password_change/done/",
        PasswordChangeDoneView.as_view(template_name="authapp/password_change_done.html"),
    ...
    path(
        ...
        PasswordResetConfirmView.as_view(
            template_name="authapp/password_reset_confirm.html", success_url=reverse_lazy("authapp:login")
        ),
